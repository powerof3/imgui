...
enum ImGuiStyleVar_
{
    ...
    ImGuiStyleVar_TextShadowOffset,         // ImVec2    TextShadowOffset
    ImGuiStyleVar_COUNT
};
...
struct ImGuiStyle
{
    ...
    ImVec2      TextShadowOffset;           // Offset of drop shadow. Set to (0,0) to disable shadow.
